...
- A five-lens adversarial review (brief compliance, accessibility, copy and
  ...
  | Finding | Done |
  |---|---|
  | Three more caveat boxes in the deleted card's style survived on the two State Pension pages ("Taken at 66", "What may apply instead" twice) and were not flagged. Confirmed 3 of 3. | Cards and heads removed; the sentences stay as plain text under the result (`.pb-floor`), the way the floor sentence did. |
